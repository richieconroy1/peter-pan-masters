  ...
  return (
    <>
      <style>{`
        ...
        .player-name { color: #f5f0e0; font-style: italic; letter-spacing: 0.02em; font-size: 15px; }
        .player-salary { color: #a8c4ae; font-size: 13px; font-style: normal; letter-spacing: 0.05em; }
        .player-check {
